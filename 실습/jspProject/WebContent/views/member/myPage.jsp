		...
		<form id="updateForm" name="updateForm" action="<%= request.getContextPath() %>/update.me" method="post">
			<table>
				...
				<tr>
					<!-- 비밀번호 변경하기 -->
					<td>* 비밀번호</td>
					<td><input type="password" maxlength="15" name="userPwd" value="<%= userPwd %>" readonly></td>
				...
				<tr>
					<td>연락처</td>
					<td><input type="tel" maxlength="11" name="phone" placeholder="(-없이)01012345678" value="<%= phone %>"></td>
				</tr>
				<tr>
					<td>이메일</td>
