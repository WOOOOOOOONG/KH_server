...
<body>
	...
	<!-- 포워딩 전에 응답 객체에 작성한 것(정확하게는 버퍼에 기록 되어 있음)은
	...
	<!-- 예를 들어서 전달 값의 결과에 따라 다른 JSP 페이지로 요청 처리를 전달할 때 사용할 수 있음
		전달하는 페이지에 내부적으로 request, response 객체가 같이 전달 되며 url은 변경 되지 않음 -->
