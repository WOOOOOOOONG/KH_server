...
<body>
	...
	<p>
		...
		JSP 에서 사용하는 커스텀 태그로, 공통으로 사용하는 코드의 집합을 사용하기 쉽게<br>
	...
	3) WebContent/WEB-INF/lib에 추가<br>
	
	<hr>
	
	<h3>* JSTL 선언 방법</h3>
	<p>
		JSTL을 사용 하고자 하는 JSP 페이지의 상단 page 지시자 아래에<br>
		taglib 지시자를 사용하여 선언해야함<br><br>
		
		&lt;%@ taglib prefix="사용하고자 하는 접두사" uri="tld 파일 상의 uri" %&gt;
		
		<br>
		prefix : 접두사. 다른 태그와 구별할 수 있는 name space를 제공함. <br>
		uri : 실제 웹 상의 주소가 아닌, 태그 라이브러리를 나타내는 식별자. <br>
			  tld 파일 상에 uri 값을 가리키며, 이 지시자를 통해 작성한 태그 이름과<br>
			    매칭되는 자바 코드를 찾음.
	...
	변수와 url, 조건문, 반복문 등의 로직과 관련 된 JSTL 문법을 제공 <br><br>
